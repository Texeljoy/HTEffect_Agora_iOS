Pod::Spec.new do |spec|
   ...
   spec.platform      = :ios
   spec.source        = { :git => "" }
   spec.vendored_frameworks = "HTEffectLib/HTEffect.framework"
#   spec.resource_bundles    = {"HTEffectLib" => "HTEffectLib/HTEffect.bundle"}
spec.resources = "HTEffectLib/HTEffect.bundle"
